...
public class CbLoanTablePaymentControl extends BaseControl {
    ...
    public List<CbLoanTablePaymentBean> mappingBean(ResultSet rs) throws Exception {
        List<CbLoanTablePaymentBean> listBean = new ArrayList<>();
        while (rs.next()) {
    ...
    public List<CbLoanTablePaymentBean> listCbLoanTablePayment() {
        try {
    ...
    public List<CbLoanTablePaymentBean> listCbLoanTablePayment(String loan_doc_no) {
        try {
            String sql = "select * from cb_loan_table_payment "
    ...
    public CbLoanTablePaymentBean tablePayment(String loan_doc_no) {
        try {
            ...
            ResultSet rs = MySQLConnect.getResultSet(sql);
            List<CbLoanTablePaymentBean> listBean = mappingBean(rs);
            if (listBean.isEmpty()) {
                return null;
            }
