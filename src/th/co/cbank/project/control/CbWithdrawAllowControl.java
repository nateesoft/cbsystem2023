...
public class CbWithdrawAllowControl extends BaseControl {
    ...
    public List<CbWithdrawAllowBean> mappingBean(ResultSet rs) throws Exception {
    ...
    public List<CbWithdrawAllowBean> listCbWithdrawAllow() {
        try {
    ...
    public List<CbWithdrawAllowBean> listCbWithdrawAllow(String account_no) {
        try {
    ...
    public CbWithdrawAllowBean getCbWithdrawAllow(String account_no) {
        try {
            String sql = "select * from cb_withdraw_allow where account_no='" + account_no + "'";
            ResultSet rs = MySQLConnect.getResultSet(sql);
            List<CbWithdrawAllowBean> listBean = mappingBean(rs);
            if (listBean.isEmpty()) {
                return null;
            }
