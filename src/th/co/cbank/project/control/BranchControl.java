...
public class BranchControl extends BaseControl {
    ...
    public List<BranchBean> mappingBean(ResultSet rs) throws Exception {
        List<BranchBean> listBean = new ArrayList<>();
        while (rs.next()) {
    ...
    public List<BranchBean> listBranch() {
        try {
    ...
    public BranchBean getData() {
        List<BranchBean> listBean = listBranch();
        if (listBean.isEmpty()) {
            return null;
        }
    ...
    public boolean updatePatial(BranchBean bean) {
        try {
            String sql = "update cb_branch set "
                    + "code='" + bean.getCode() + "',"
                    + "name='" + ThaiUtil.Unicode2ASCII(bean.getName()) + "',"
                    + "addressno='" + ThaiUtil.Unicode2ASCII(bean.getAddressNo()) + "',"
                    + "locality='" + ThaiUtil.Unicode2ASCII(bean.getLocality()) + "',"
                    + "subprovince='" + ThaiUtil.Unicode2ASCII(bean.getSubProvince()) + "',"
                    + "province='" + ThaiUtil.Unicode2ASCII(bean.getProvince()) + "',"
                    + "post='" + bean.getPost() + "',"
                    + "tel_no='" + bean.getTel_No() + "',"
                    + "fax_no='" + bean.getFax_No() + "',"
                    + "e_mail='" + bean.getE_Mail() + "',"
                    + "manager='" + ThaiUtil.Unicode2ASCII(bean.getManager()) + "' "
                    + "where code = '" + bean.getCode() + "'";
            return update(sql) > 0;
        } catch (Exception e) {
            logger.error(e.getMessage());
