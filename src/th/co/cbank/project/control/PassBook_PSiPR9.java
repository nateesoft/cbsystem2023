...
public class PassBook_PSiPR9 {
    ...
    private final Logger logger = Logger.getLogger(PassBook_PSiPR9.class);
    ...
    public void printTransactionOrange2(List<ReportOrangeBean> listBean, boolean print) {
        Map m = new HashMap();
        //clear map is null
        for (int i = 1; i <= 168; i++) {
            m.put("p" + i, "");
        ...
        for (int i = 0; i < listBean.size(); i++) {
            ...
            if (lineInt == lineMax) {
                ...
                MessageAlert.infoPopup(this.getClass(), "กรุณากลับหน้าสมุดเพื่อทำรายการใหม่");
            } else {
                m = getHashMap(m, p, lineInt);
            }
        }
    ...
    public void printTransactionGreen2(List<ReportGreenBean> listBean, boolean print) {
        Map m = new HashMap();
        //clear map is null
        for (int i = 1; i <= 168; i++) {
            m.put("p" + i, "");
    ...
    public void printFrontBook(String accCode, String accName, String bookNo, String accType) {
        Map m = new HashMap();
        m.put("AccountCode", addSpace(accCode));
        m.put("AccountName", accName);
        m.put("BookNo", addSpace(bookNo));
        m.put("BARCODE", accCode); // same accountCode
