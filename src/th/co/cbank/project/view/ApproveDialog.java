...
public class ApproveDialog extends BaseDialogSwing {
    ...
    private void initTable() {
        ...
        List<Object[]> listModel = profileControl.getApproveLimitMoreZero(Value.CUST_CODE);
    ...
    private void searchCustomer() {
        ...
        CbProfileControl profileControl = new CbProfileControl();
        List<Object[]> listModel = profileControl.searchCustomerApproveLimitMoreZero(Value.CUST_CODE, txtSearch.getText());
        for (Object[] data : listModel) {
            model.addRow(data);
        }
    }
