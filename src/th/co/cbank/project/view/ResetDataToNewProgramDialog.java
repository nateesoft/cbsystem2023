...
import th.co.cbank.project.control.DatabaseUtilController;
...
public class ResetDataToNewProgramDialog extends BaseDialogSwing {
    ...
    private final DatabaseUtilController dbController = new DatabaseUtilController();
...
//            saveConfig();
            ...
            MessageAlert.warningPopup(this, "กรุณากำหนดชื่อสำหรับบันทึกข้อมูล");
        }
...
//        loadConfig();
    ...
    private void resetDB() {
        ...
        configControl.resetDB();
        MessageAlert.infoPopup(this, "Clear Database Empty.");
    ...
    private void loadTables() {
        ...
        int count = 0;
        List<String> listTableNames = dbController.showTables();
    ...
    private void emptyTableSelected() {
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            if (isSelected) {
                try {
                    dbController.emptyTable(tableName);
                    countSave++;
                    isSave = true;
                } catch (Exception ex) {
        ...
        if (isSave) {
            MessageAlert.infoPopup(this, "ล้างข้อมูลตารางเรียบร้อยแล้ว " + countSave + " ตาราง");
            new File("cbanksystem.running").delete();
            System.exit(0);
        }
    }
